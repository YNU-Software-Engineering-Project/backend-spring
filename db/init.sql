...
(200000, '여행자를 위한 올인원 멀티툴', '캠핑부터 도심 여행까지, 하나로 충분한 멀티툴', 700000, 1000000, 'ONGOING','A0070', '트래블팩', 'organizer2@example.com', 'tax2@example.com', '/path/to/id_card2.jpg', 1, '2024-09-22 11:12:11'),
...
(230000, '반려동물을 위한 스마트 피딩기', '자동 급식 및 원격 제어 기능으로 편리한 반려동물 관리', 3000000, 6000000, 'REVIEW', 'A0160', '펫케어', 'organizer4@example.com', 'tax4@example.com', '/path/to/id_card4.jpg', 1, '2024-09-22 11:14:11'),
...
(268000, '스마트홈을 위한 차세대 AI 스피커', 'AI 기술로 더욱 똑똑해진 스마트 스피커', 10000000, 15000000, 'ONGOING', 'A0100', '홈스마트', 'organizer6@example.com', 'tax6@example.com', '/path/to/id_card6.jpg', 1, '2024-09-22 11:16:11'),
(328300, '학생들을 위한 다기능 노트북 스탠드', '높이 조절이 가능한 인체공학적 디자인의 노트북 스탠드', 1000000, 2000000, 'REVIEW', 'A0100', '스탠드컴퍼니', 'organizer7@example.com', 'tax7@example.com', '/path/to/id_card7.jpg', 1, '2024-09-22 11:17:11'),
(981240, '신개념 휴대용 전동칫솔', '초고속 전동 칫솔로 어디서나 간편한 구강 관리', 1500000, 2500000, 'ONGOING', 'A0020', '클린덴트', 'organizer8@example.com', 'tax8@example.com', '/path/to/id_card8.jpg', 1, '2024-09-22 11:18:11'),
...
(359000, '한 번 충전으로 한 달 사용 가능한 무선 청소기', '강력한 흡입력과 긴 사용시간을 자랑하는 무선 청소기', 3000000, 5000000, 'ONGOING', 'A0100', '클린홈', 'organizer10@example.com', 'tax10@example.com', '/path/to/id_card10.jpg', 1, '2024-09-22 11:20:11'),
(862030, '프리미엄 블루투스 이어폰', '고음질 무선 블루투스 이어폰으로 새로운 음악 경험', 7000000, 10000000, 'CLOSED', 'A0150', '뮤직소울', 'organizer11@example.com', 'tax11@example.com', '/path/to/id_card11.jpg', 1, '2024-09-22 11:21:11'),
(878990, '실내외 모두 사용 가능한 스마트 LED 조명', '자동 밝기 조절 및 다양한 색상 변경이 가능한 LED 조명', 1200000, 2500000, 'REVIEW', 'A0100', '라이트업', 'organizer12@example.com', 'tax12@example.com', '/path/to/id_card12.jpg', 1, '2024-09-22 11:22:11'),
(137560, '친환경 소재로 만든 프리미엄 침구 세트', '편안한 수면을 위한 천연 소재 침구 세트', 5000000, 9000000, 'CLOSED', 'A0020', '슬리프리', 'organizer13@example.com', 'tax13@example.com', '/path/to/id_card13.jpg', 1, '2024-09-22 11:23:11'),
...
(234000, '차세대 무선 충전 패드', '모든 기기와 호환 가능한 초고속 무선 충전 패드', 3000000, 4000000, 'CLOSED', 'A0100', '테크센스', 'organizer15@example.com', 'tax15@example.com', '/path/to/id_card15.jpg', 1, '2024-09-22 11:25:11');
