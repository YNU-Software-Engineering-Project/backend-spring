...
INSERT INTO funding (title, project_summary, current_amount, target_amount, current, category, organizer_name, organizer_email, tax_email, organizer_id_card, user_id, created_at)
VALUES
('10초 완판 | 차원이 다른 스마트 가습기', '강력한 미세 분사와 자동 습도 조절 기능 탑재', 1500000, 5000000, 'DRAFT', 'A0100', '더워터', 'organizer1@example.com', 'tax1@example.com', '/path/to/id_card1.jpg', 1, '2024-09-22 11:11:11'),
('여행자를 위한 올인원 멀티툴', '캠핑부터 도심 여행까지, 하나로 충분한 멀티툴', 700000, 1000000, 'DRAFT','B0380', '트래블팩', 'organizer2@example.com', 'tax2@example.com', '/path/to/id_card2.jpg', 1, '2024-09-22 11:12:11'),
('한정판 | 차세대 친환경 에코백', '100% 재활용 소재로 만들어진 에코백', 5000000, 8000000, 'DRAFT', 'A0170', '에코리브', 'organizer3@example.com', 'tax3@example.com', '/path/to/id_card3.jpg', 1, '2024-09-22 11:13:11'),
('반려동물을 위한 스마트 피딩기', '자동 급식 및 원격 제어 기능으로 편리한 반려동물 관리', 3000000, 6000000, 'REVIEW', 'B0910', '펫케어', 'organizer4@example.com', 'tax4@example.com', '/path/to/id_card4.jpg', 1, '2024-09-22 11:14:11'),
('세상을 바꾸는 휴대용 태양광 충전기', '휴대가 간편한 태양광 충전기, 어디서나 충전 가능', 2000000, 3000000, 'REVIEW_COMPLETED', 'A0100', '솔라팩', 'organizer5@example.com', 'tax5@example.com', '/path/to/id_card5.jpg', 1, '2024-09-22 11:15:11'),
('스마트홈을 위한 차세대 AI 스피커', 'AI 기술로 더욱 똑똑해진 스마트 스피커', 10000000, 15000000, 'DRAFT', 'B0550', '홈스마트', 'organizer6@example.com', 'tax6@example.com', '/path/to/id_card6.jpg', 1, '2024-09-22 11:16:11'),
('학생들을 위한 다기능 노트북 스탠드', '높이 조절이 가능한 인체공학적 디자인의 노트북 스탠드', 1000000, 2000000, 'REVIEW', 'B0540', '스탠드컴퍼니', 'organizer7@example.com', 'tax7@example.com', '/path/to/id_card7.jpg', 1, '2024-09-22 11:17:11'),
('신개념 휴대용 전동칫솔', '초고속 전동 칫솔로 어디서나 간편한 구강 관리', 1500000, 2500000, 'ONGOING', 'B0540', '클린덴트', 'organizer8@example.com', 'tax8@example.com', '/path/to/id_card8.jpg', 1, '2024-09-22 11:18:11'),
('100% 천연 성분의 스킨케어 제품', '피부에 자극 없는 순한 천연 스킨케어', 800000, 2000000, 'ONGOING', 'A0020', '네이처케어', 'organizer9@example.com', 'tax9@example.com', '/path/to/id_card9.jpg', 1, '2024-09-22 11:19:11'),
('한 번 충전으로 한 달 사용 가능한 무선 청소기', '강력한 흡입력과 긴 사용시간을 자랑하는 무선 청소기', 3000000, 5000000, 'ONGOING', 'B0540', '클린홈', 'organizer10@example.com', 'tax10@example.com', '/path/to/id_card10.jpg', 1, '2024-09-22 11:20:11'),
('프리미엄 블루투스 이어폰', '고음질 무선 블루투스 이어폰으로 새로운 음악 경험', 7000000, 10000000, 'REVIEW_COMPLETED', 'B0590', '뮤직소울', 'organizer11@example.com', 'tax11@example.com', '/path/to/id_card11.jpg', 1, '2024-09-22 11:21:11'),
('실내외 모두 사용 가능한 스마트 LED 조명', '자동 밝기 조절 및 다양한 색상 변경이 가능한 LED 조명', 1200000, 2500000, 'REVIEW', 'B0530', '라이트업', 'organizer12@example.com', 'tax12@example.com', '/path/to/id_card12.jpg', 1, '2024-09-22 11:22:11'),
('친환경 소재로 만든 프리미엄 침구 세트', '편안한 수면을 위한 천연 소재 침구 세트', 5000000, 9000000, 'CLOSED', 'B0950', '슬리프리', 'organizer13@example.com', 'tax13@example.com', '/path/to/id_card13.jpg', 1, '2024-09-22 11:23:11'),
('한정판 스마트 커피머신', '원터치로 즐기는 고품질 커피, 스마트 기능 탑재', 8000000, 12000000, 'DRAFT', 'A0100', '커피클럽', 'organizer14@example.com', 'tax14@example.com', '/path/to/id_card14.jpg', 1, '2024-09-22 11:24:11'),
('차세대 무선 충전 패드', '모든 기기와 호환 가능한 초고속 무선 충전 패드', 3000000, 4000000, 'CLOSED', 'B0590', '테크센스', 'organizer15@example.com', 'tax15@example.com', '/path/to/id_card15.jpg', 1, '2024-09-22 11:25:11');
